...
public class Floor extends ArrayModel {
    ...
    public void init(float boundSize) {
        ...
        final float[] coords = new float[]{
                // +X, +Z quadrant
                extent, 0, 0, 0, 0, 0, 0, 0, extent, extent, 0, 0, 0, 0, extent, extent, 0, extent,

                // -X, +Z quadrant
                0, 0, 0, -extent, 0, 0, -extent, 0, extent, 0, 0, 0, -extent, 0, extent, 0, 0, extent,

                // +X, -Z quadrant
                extent, 0, -extent, 0, 0, -extent, 0, 0, 0, extent, 0, -extent, 0, 0, 0, extent, 0, 0,

                // -X, -Z quadrant
                0, 0, -extent, -extent, 0, -extent, -extent, 0, 0, 0, 0, -extent, -extent, 0, 0, 0, 0, 0,};
        ...
        glProgram = Util.compileProgram(R.raw.floor_vertex, R.raw.floor_fragment, new String[]{"a_Position", "a_Normal"});
